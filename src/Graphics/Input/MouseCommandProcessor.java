 ...
 * @author lennylinux
 */
public class MouseCommandProcessor implements MouseEventProcessor, GUIEventListener {
    ...
    public MouseCommandProcessor() {
        this(null);
    }

    public MouseCommandProcessor(InteractiveComponent parent) {
